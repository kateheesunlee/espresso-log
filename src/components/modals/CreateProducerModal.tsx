...
const CreateProducerModal: React.FC<CreateProducerModalProps> = ({
  visible,
  pendingName = '',
  onRequestClose,
  onSave,
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.header}>
            <Text style={styles.headerTitle}>Add New Producer/Farm</Text>
            <TouchableOpacity
          ...
          >
            <FormField label='Producer/Farm Name' required>
              <TextInput
                style={styles.input}
                value={name}
                onChangeText={setName}
                placeholder='e.g., Hacienda La Esmeralda'
            ...
            <FormField label='Aliases (Optional)'>
              <TextInput
                ...
                placeholder='e.g., La Esmeralda, Esmeralda'
                autoCapitalize='words'
              />
