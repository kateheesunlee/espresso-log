...
const CoffeeFilledIcon = ({ size, color, secondaryColor }: IconProps) => {
  return (
    <Svg width={size} height={size} viewBox='0 0 24 24' fill='none'>
      <Path
        d='M16.5 8.5H3.49999C3.32136 11.1667 3.07127 16.9 3.49999 18.5C3.92871 20.1 5.67863 20.8333 6.49999 21H13.5C15.1 21 16.1667 18.6667 16.5 17.5V8.5Z'
        fill={secondaryColor}
      />
      <Path
